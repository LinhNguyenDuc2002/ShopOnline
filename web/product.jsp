        ...
        <div class="product-content">
            ...
            <div class="product-right">
                ...
                <p class="text">Category: <span>${requestScope.sanphamchitiet.category.name}</span> | Status: 
                    <c:choose>
                        <c:when test="${requestScope.sanphamchitiet.available > 0}">
                            <span>Available: ${requestScope.sanphamchitiet.available}</span>
                        </c:when>
                ...
                <p class="price text">${requestScope.sanphamchitiet.getPrice()}</p>                    
                    ...
                    <button class="button1" style="margin-top: 100px; margin-left: 0; width: fit-content;">ADD TO CART</button>
            </div>
        </div>
        <!-- MÔ TẢ -->
        <div class="mo-ta">
